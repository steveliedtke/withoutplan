...
import de.ggj14bremen.withoutplan.util.SystemUiHider;
...
public class TimerActivity extends Activity {
		...
		pauseButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(paused){
					startTimer(total);
					paused = false;
					pauseButton.setText(getText(R.string.pause));
				}else{
					paused = true;
					timer.cancel();
					pauseButton.setText(getText(R.string.resume));
				}
			}
		});
	}
	...
	protected void onStart() {
		this.countDown = (TextView) this.findViewById(R.id.fullscreen_content);
